  ...
  return (
    <div className="min-h-screen bg-background flex items-center justify-center px-4 py-10">
      <div className="w-full max-w-sm">
        <div className="bg-card border border-border rounded-3xl overflow-hidden shadow-xl bg-white">

          {/* Header */}
          <div className="relative bg-white px-6 pt-5 pb-4 overflow-hidden">
            ...
            <div className="flex items-start justify-between">
              ...
              <div className="w-20 h-20 flex-shrink-0 ml-2 relative">
                ...
                <div className="absolute -bottom-1 -right-1 w-8 h-8 bg-amber-100 rounded-xl border-2 border-white flex items-center justify-center shadow-sm">
                  <span className="text-xs font-black text-amber-700">K</span>
                </div>
              </div>
            </div>
          </div>

          <form onSubmit={handleSubmit} className="px-6 pb-6 space-y-3.5 bg-white">
            <div>
            ...
            <div className="grid grid-cols-3 gap-2">
              {["Google", "Apple", "Facebook"].map((label) => (
                <button key={label} type="button" className="flex items-center justify-center gap-1 py-2.5 border border-border rounded-xl text-xs font-semibold hover:bg-muted transition-colors">
                  <span className={`font-black text-sm ${label === "Google" ? "text-red-500" : label === "Facebook" ? "text-blue-600" : "text-foreground"}`}>
