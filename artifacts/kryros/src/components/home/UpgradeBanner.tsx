    ...
    <section className="max-w-7xl mx-auto px-4 md:px-6 mb-6">
      <div className="relative rounded-2xl overflow-hidden" style={{ height: 180 }}>
        ...
        <div
          ...
          style={{
            background:
              "linear-gradient(100deg, rgba(5,15,30,0.88) 0%, rgba(5,20,40,0.65) 55%, rgba(5,40,40,0.28) 100%)",
          }}
        />

        {/* Content row — fixed height, single row */}
        <div className="relative z-10 flex items-center justify-between h-full px-5 py-5 gap-3">

          {/* Left — heading, description, button */}
          <div className="flex flex-col justify-center gap-2">
            <h2 className="text-[17px] md:text-2xl font-black text-white leading-snug whitespace-nowrap">
            ...
            <Link href="/shop">
              <button className="flex items-center gap-1.5 px-4 py-2 bg-teal-500 text-white rounded-xl text-[11px] font-bold hover:bg-teal-400 transition-all active:scale-95 w-fit whitespace-nowrap">
